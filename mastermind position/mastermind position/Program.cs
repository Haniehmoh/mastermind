            ...
            do
            {
                ...
                for (int essai = 1; essai <= 10; essai++)
                {
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        ...
                        else if (secret.Contains(reponse[i].ToString()))
                        {
                            correctColors++;
                        }
                    }
                    ...
                    Console.WriteLine($"OK={correctColors} couleur(s) correcte(s)");
                    Console.WriteLine($"Poition={correctPositions} position(s) correcte(s)");
